import { uid } from "uid"
import { ordersFeedReducer, ordersFeedInitialState, ordersFeedActions } from "./orders-feed-slice"
import { generateRandomString } from "../../../utils/test-utils"

type State = typeof ordersFeedInitialState
type Message = NonNullable<State["message"]>
type Order = NonNullable<Message["orders"]>[number]

const initialState: Readonly<State> = ordersFeedInitialState
const reducer = ordersFeedReducer
const actions = ordersFeedActions
