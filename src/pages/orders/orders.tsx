...
const _mockOrders: Record<string, Order> = {
  "1": {
    number: "034535",
...
export const OrdersPage: React.FC = () => {
  ...
  return (
    <Flex direction="column" align="stretch" grow={1} gap={6} className="custom-scroll">
      {Object.entries(_mockOrders).map(([k, item], i) => {
        return (
          <Flex key={k} direction="column" align="stretch" p={6} bg={appColors.bodyAltBackground} borderRadius="40px">
            ...
            <Flex direction="column" grow={1} gap={6}>
              ...
              <Flex justify="stretch" gap={6}>
                <Flex grow={1}>
                  <AvatarGroup size="lg" max={10} spacing={-4}>
